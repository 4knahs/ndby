...
public class RMAppAttemptImpl implements RMAppAttempt, Recoverable {
  ...
  private static final StateMachineFactory<RMAppAttemptImpl,
      ...
      .addTransition(RMAppAttemptState.ALLOCATED_SAVING, 
          ...
          RMAppAttemptEventType.ATTEMPT_SAVED, new AttemptLaunchTransition())
      .addTransition(RMAppAttemptState.ALLOCATED_SAVING, 
          RMAppAttemptState.ALLOCATED_SAVING,
  ...
  public void recover(RMState state) {
    ...
    // TODO other data
    // TODO transition attempt state to killed/failed and set status
  }
    ...
    public RMAppAttemptState transition(RMAppAttemptImpl appAttempt,
      ...
      if(store != null) {
        ...
        LOG.info("Storing attempt: AppId: " + 
                  ...
                  + " MasterContainer: " + appAttempt.masterContainer);
        store.storeApplicationAttempt(appAttempt);
  ...
  private static final class AttemptLaunchTransition extends BaseTransition {
    @Override
    public void transition(RMAppAttemptImpl appAttempt,
        RMAppAttemptEvent event) {
      appAttempt.launchAttempt();
